...
#### Authors: Michael Sebek, Andrea Piras, Lucía Prieto Santamaría, Shi Chenghao, Gordana Ispirova, Giulia Menichetti (giulia.menichetti@channing.harvard.edu)
...
For the 2025 update of CPIExtract, the databases are now unified by InChIKey as well as CID. This allows CPIExtract to collect interactions at a purely structural or a deeper stereochemical level by match to the first block of InChIKey only or matching to the full InChIKey. Such matching especially helps when the different datasets assign their interactions to a default stereochemsitry; for example flat stereochemistry. These data are available within our [Dropbox](https://www.dropbox.com/scl/fi/h01bweayndx4zlql2xhe1/Databases.zip?rlkey=hoxh9942q0fohe9wp09p88c1i&st=x4yxznp1&dl=0).
